alter table move		add ExternalId blob(16) not null;
alter table detail		add ExternalId blob(16) not null;
alter table schedule	add ExternalId blob(16) not null;
