...
Scenario: Bj01. Enable a Category that doesn't exist (E)
...
Scenario: Bj02. Enable a Category already enabled (E)
...
Scenario: Bj99. Enable a Category with info all right (S)
