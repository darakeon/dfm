...
Scenario: BdE02. Close an Account already closed
...
Scenario: BdE03. Close an Account that has no moves
...
Scenario: BdS01. Close an Account with info all right
	Given I have a category
...
Scenario: BdS02. Close an Account with schedule
	Given I have a category
...
Scenario: BdS03. Close an Account with disabled schedule
	Given I have a category
