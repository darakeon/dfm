...
Scenario: S01. Delete an Account that had moves
	Given I have a category
...
Scenario: S02. Delete an Account without moves
	Given I give a url of the account BeS02 without moves
	When I try to delete the account
	Then I will receive no core error
	And the account will be deleted

Scenario: S03. Delete an Account with schedule
	Given I have a category
