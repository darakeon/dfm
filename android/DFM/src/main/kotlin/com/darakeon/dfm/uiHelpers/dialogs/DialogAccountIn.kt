...
class DialogAccountIn<T : SmartStatic>(list: JSONArray?, private val activity: Activity, private val message: Message<T>, private val move: Move?) : DialogSelectClickListener(list) {
