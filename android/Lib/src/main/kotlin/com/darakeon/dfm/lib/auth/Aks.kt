...
class Aks(context: Context) {
	private abstract class BaseAks {
	...
	private class OldAks(val context: Context) : BaseAks() {
	...
	fun encrypt(text: String): String =
		aks?.encrypt(text) ?: reverse(text, true)

	fun decrypt(text: String): String =
		aks?.decrypt(text) ?: reverse(text, false)

	private fun reverse(text: String, add: Boolean): String {
		var result = ""
