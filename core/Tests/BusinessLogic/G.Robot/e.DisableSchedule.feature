...
Scenario: Ge01. Disable a Schedule that doesn't exist
...
Scenario: Ge02. Disable a Schedule already disabled
...
Scenario: Ge03. Disable a Schedule with info all right
	Given I have this schedule to create
			| Description | Date       | Nature | Value | Times | Boundless | Frequency | ShowInstallment |
...
Scenario: Ge04. Disable another user's Schedule
	Given I have this schedule to create
			| Description | Date       | Nature | Value | Times | Boundless | Frequency | ShowInstallment |
...
Scenario: Ge05. Disable a Schedule with details
	Given I have this schedule to create
			| Description | Date       | Nature | Value | Times | Boundless | Frequency | ShowInstallment |
...
Scenario: Ge06. Not disable a Schedule if user is marked for deletion
	Given I have this schedule to create
			| Description | Date       | Nature | Value | Times | Boundless | Frequency | ShowInstallment |
...
Scenario: Ge07. Not disable a Schedule if user requested wipe
	Given I have this schedule to create
			| Description | Date       | Nature | Value | Times | Boundless | Frequency | ShowInstallment |
...
Scenario: Ge08. Not disable if not signed last contract
	Given I have this schedule to create
			| Description | Date       | Nature | Value | Times | Boundless | Frequency | ShowInstallment |
