Feature: Gs. Delete Expired Orders
...
Scenario: Gs03. User marked for deletion
	Given order start date 2023-01-01
		And order end date 2024-09-06
		And order account account
		And an export is ordered
...
Scenario: Gs04. User requested wipe
	Given order start date 2023-01-01
		And order end date 2024-09-06
		And order account account
		And an export is ordered
...
Scenario: Gs05. Without sign last contract
	Given order start date 2023-01-01
		And order end date 2024-09-06
		And order account account
		And an export is ordered
...
Scenario: Gs07. Not yet exported
	Given order start date 2023-01-01
		And order end date 2024-09-06
		And order account account
		And an export is ordered
