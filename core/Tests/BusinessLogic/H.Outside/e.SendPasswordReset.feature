Feature: He. Send password reset
...
Scenario: He01. Send with email that doesn't exist
	Given I pass an e-mail that doesn't exist
	When I try to send the e-mail of password reset
	Then I will receive no core error

Scenario: He02. Send with info all right
	When I try to send the e-mail of password reset
	Then I will receive no core error

Scenario: He03. Not send if user is marked for deletion
	Given the user is marked for deletion
	When I try to send the e-mail of password reset
	Then I will receive this core error: UserDeleted

Scenario: He04. Not send if user requested wipe
