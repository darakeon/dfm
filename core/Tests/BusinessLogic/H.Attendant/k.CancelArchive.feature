Feature: Hk. Cancel Archive

Background:
	Given test user login
		And I have two accounts

Scenario: Hk01. Unlogged user
	Given I have no logged user (logoff)
	When cancel archive
	Then I will receive this core error: Uninvited

Scenario: Hk02. User marked for deletion
	Given the user is marked for deletion
	When cancel archive
	Then I will receive this core error: UserDeleted

Scenario: Hk03. User requested wipe
	Given the user asked data wipe
	When cancel archive
	Then I will receive this core error: UserAskedWipe

Scenario: Hk04. Without sign last contract
	Given there is a new contract
	When cancel archive
	Then I will receive this core error: NotSignedLastContract

Scenario: Hk05. Invalid archive
	When cancel archive
	Then I will receive this core error: ArchiveNotFound

Scenario: Hk06. Archive wrong user
...
Scenario: Hk10. Archive canceled
	Given a moves file with this content
			| Description         | Date       | Nature   | Out         | In         | Value |
			| Move {scenarioCode} | 2024-07-21 | Transfer | Account Out | Account In | 1     |
		And the moves file was imported
...
Scenario: Hk11. Archive mixed stati with one success
	Given a moves file with this content
			| Description         | Date       | Nature   | Out         | In         | Value |
			| Move {scenarioCode} | 2024-07-21 | Transfer | Account Out | Account In | 1     |
			| Move {scenarioCode} | 2024-07-21 | Transfer | Account Out | Account In | 1     |
