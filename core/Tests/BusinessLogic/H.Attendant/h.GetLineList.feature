...
Scenario: Hh01. Unlogged user
	Given I have no logged user (logoff)
	When get line list
	Then I will receive this core error: Uninvited

Scenario: Hh02. User marked for deletion
	Given the user is marked for deletion
	When get line list
	Then I will receive this core error: UserDeleted

Scenario: Hh03. User requested wipe
	Given the user asked data wipe
	When get line list
	Then I will receive this core error: UserAskedWipe

Scenario: Hh04. Without sign last contract
	Given there is a new contract
	When get line list
	Then I will receive this core error: NotSignedLastContract

Scenario: Hh05. Invalid archive
	When get line list
	Then I will receive this core error: ArchiveNotFound

Scenario: Hh06. Archive wrong user
...
Scenario: Hh07. Get lines
	Given a moves file with this content
			...
			| Move {scenarioCode} 6 | 2024-07-21 | Category | In       |                 | Account In     | 1     |            |               |         |        |             |               |         |        |             |               |         |        |             |
		And the moves file was imported
	...
	Then I will receive no core error
		And the line list will be
			...
			| 6        | Move {scenarioCode} 6 | 2024-07-21 | Category | In       |                 | Account In     | 1     |            | OutOfLimit |               |         |        |             |               |         |        |             |               |         |        |             |
