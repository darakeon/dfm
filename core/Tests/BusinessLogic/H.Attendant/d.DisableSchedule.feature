...
Scenario: Hd01. Disable a Schedule that doesn't exist
...
Scenario: Hd02. Disable a Schedule already disabled
...
Scenario: Hd03. Disable a Schedule with info all right
	Given I have this schedule to create
			| Description | Date       | Nature | Value | Times | Boundless | Frequency | ShowInstallment |
...
Scenario: Hd04. Disable another user's Schedule
	Given I have this schedule to create
			| Description | Date       | Nature | Value | Times | Boundless | Frequency | ShowInstallment |
...
Scenario: Hd05. Disable a Schedule with details
	Given I have this schedule to create
			| Description | Date       | Nature | Value | Times | Boundless | Frequency | ShowInstallment |
...
Scenario: Hd06. Not disable a Schedule if user is marked for deletion
	Given I have this schedule to create
			| Description | Date       | Nature | Value | Times | Boundless | Frequency | ShowInstallment |
...
Scenario: Hd07. Not disable a Schedule if user requested wipe
	Given I have this schedule to create
			| Description | Date       | Nature | Value | Times | Boundless | Frequency | ShowInstallment |
...
Scenario: Hd08. Not disable if not signed last contract
	Given I have this schedule to create
			| Description | Date       | Nature | Value | Times | Boundless | Frequency | ShowInstallment |
