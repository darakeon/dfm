...
Scenario: Ha01. Get all schedules
...
Scenario: Ha02. Get all schedules after delete one
	Given I have this schedule to create
			| Description     | Date       | Nature | Value | Times | Boundless | Frequency | ShowInstallment |
...
Scenario: Ha03. Not get schedules if user is marked for deletion
	Given the user is marked for deletion
	When ask for the schedule list
	Then I will receive this core error: UserDeleted

Scenario: Ha04. Not get schedules if user requested wipe
	Given the user asked data wipe
	When ask for the schedule list
	Then I will receive this core error: UserAskedWipe

Scenario: Ha05. Not get schedules if not signed last contract
