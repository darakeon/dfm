...
Scenario: Eb01. Try to get Move with wrong ID
...
Scenario: Eb02. Get the Move by ID
	Given I pass valid Move ID
	When I try to get the move
	Then I will receive no core error
		And I will receive the move

Scenario: Eb03. Get another user's Move
	Given I pass valid Move ID
...
Scenario: Eb04. Get move generated by schedule
...
Scenario: Eb05. Not get the Move if user is marked for deletion
	Given I pass valid Move ID
		But the user is marked for deletion
	When I try to get the move
	Then I will receive this core error: UserDeleted

Scenario: Eb06. Not get the Move if user requested wipe
	Given I pass valid Move ID
		But the user asked data wipe
	When I try to get the move
	Then I will receive this core error: UserAskedWipe

Scenario: Eb07. Not get if not signed last contract
	Given I pass valid Move ID
