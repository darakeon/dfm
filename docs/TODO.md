...
- Difficulty: how hard is to do the job (1-4)
- Importance: how positive is the impact caused on system (1-4)
- Points: calculation based on Difficulty and Importance, to decide priority (1-7)
- Issue: github issue about the task (if it exists)
- Depend: which other task it depends on (if it exists)
...
| Robot to delete not accessed users | 2 | 3 | 3 | 4 | [#49](https://github.com/darakeon/dfm/issues/49) | robot / login date |
...
| Add system tips (based on user "age" = number of times them accessed) (can be disabled by unsubscribe or config) | 3 | 3 | 3 | 4 |  |  |
...
| Create Market - group of moves, each one of one category, to when you are shopping (mobile) | 3 | 3 | 2 | 3 |  |  |
