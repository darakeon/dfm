...
| Add Negative / Positive / Sum to Year summary                                           | :sheep:  |  1  |  2  |  5  |                    |                                                  |
| Add Balance Negative / Positive / Sum to Year summary                                   | :sheep:  |  1  |  2  |  5  |                    |                                                  |
...
| Move area API to another project                                                        | :ant:    |  3  |  3  |  4  |                    |                                                  |
| Make e-mail tests to check file generated by e-mail mock                                | :ant:    |  2  |  2  |  4  |                    |                                                  |
| Fix first day of account according to first move, and last day according to last move   | :ant:    |  2  |  2  |  4  |                    |                                                  |
...
| Allow to choose first screen (accounts/move) (mobile)                                   | :whale:  |  2  |  1  |  3  |                    |                                                  |
