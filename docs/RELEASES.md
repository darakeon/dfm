...
- [go to published version](#14.1.3.0)
- [go to version in development](#14.1.4.0)
- [dev version state](../../14.1.4.0/docs/RELEASES.md#14.1.4.0)
...
- [ ] Fix not adding second detail in mobile app
...
Remove warning if safer login is re-enabled
Add text about 7 days warning in email
