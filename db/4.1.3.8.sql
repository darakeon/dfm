...
'
		from contract
		where version = '4.1.3.8'
	union all
	select 'pt-BR', id, '
{
	"Text": "O sistema Don''t fly Money, abaixo constando como Sistema, e a pessoa que registrou-se no sistema, abaixo constando como Usufruente, concordam com os termos descritos.",
	"Items": [
		{
			"Text": "O Sistema não possui quaisquer vínculos com instituições financeiras.",
			"Items": [
				{ "Text": "Dados apresentados no Sistema são inseridos apenas por Usufruente;" },
				{ "Text": "Movimentações feitas em Sistema não alteram dados em contas bancárias ou quaisquer outros meios externos;" },
				{ "Text": "Movimentações em meios externos não afetam os dados de Sistema, sendo estes apenas alteráveis por Usufruente via Sistema;" }
			]
		},
		{ "Text": "Dados apresentados em Sistema e decisões tomadas com base nestes dados são de total responsabilidade de Usufruente." },
		{
			"Text": "Os meios de comunicação de Sistema com Usufruente são:",
			"Items": [
				{ "Text": "E-mail cadastrado por Usufruente ao se registrar em Sistema, cujo contato é feito somente pelos endereços {{noreply_address}} - apenas para alertas automatizados - e {{support_address}} - para suporte;" },
		...
		{ "Text": "Usufruente se compromete a manter o e-mail cadastrado atualizado." },
		{ "Text": "Quaisquer atos que violem leis feitos por intermédio de Sistema são responsabilidade de Usufruente." },
		{
			"Text": "Privacidade: dados inseridos no Sistema por Usufruente são usados em relatórios pessoais, que podem ser vistos no Site ou no Aplicativo de celular, apenas por Usufruente.",
			"Items": [
				{ "Text": "O acesso a esses relatórios é controlado por login e senha, que Usufruente é responsável por manter segredo;" },
		...
		},
		{
			...
			"Items": [
				{ "Text": "Em caso de alteração, Usufruente precisa aceitar os novos termos para continuar usando o sistema;" },
				{ "Text": "Passados 90 dias, caso não aceite os novos termos, dados de Usufruente podem ser removidos permanentemente de Sistema." }
			]
		}
	]
}
