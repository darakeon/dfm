insert into migrations (name) values ('14.1.2.0');
		...
		"Items": [
			...
			{ "Text": "Cookies são usados para controlar seu acesso a informações e a segurança dos formulários deste Site;" },
			{
				...
				"Items": [
					...
					{ "Text": "Caso um login permaneça sem acesso por 30 dias ele será desativado.", "New": true }
				]
			},
			...
			},
			{
				...
				"Items": [
					...
					{ "Text": "Os termos também podem ser encontrados em http://terms.dontflymoney.com/." }
				]
			}
		]
	}
		...
		"Items": [
			...
			{ "Text": "Cookies are used to control logon and security of forms of this Website;" },
			{
				...
				"Items": [
					...
					{ "Text": "If a login is not accessed within 30 days then it will be deactivated.", "New": true }
				]
			},
			...
			},
			{
				...
				"Items": [
					...
					{ "Text": "The terms can also be find at http://terms.dontflymoney.com/." }
				]
			}
		]
	}
