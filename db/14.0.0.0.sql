insert into migrations (name) values ('14.0.0.0');
...
create table plan (
	...
	AccountOpened int not null,
	CategoryEnabled int not null,
...
alter table control
	add Plan_id bigint not null default(1),
	add constraint FK_Control_Plan
		foreign key (Plan_id)
		references plan (id);
